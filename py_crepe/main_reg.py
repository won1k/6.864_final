...
#Model params
nb_filter = int(sys.argv[2]) # Number of filters for conv layers
dense_outputs = int(sys.argv[3]) # Number of units in the dense layer
#filter_kernels = [10, 7, 3, 3, 3, 3]
filter_kernels = [int(sys.argv[4])] #Conv layer kernel size
pooling = int(sys.argv[5]) # pooling over
